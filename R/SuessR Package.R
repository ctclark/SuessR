...
SuessR.custom <- function(data, custom.data, correct.to = 1850) {
  ...
  #ln(K0)
  lnK0 <- SuessR.reference.data.custom$A1+SuessR.reference.data.custom$A2*(100/(SuessR.reference.data.custom$sst+273.15))+(SuessR.reference.data.custom$A3*log((SuessR.reference.data.custom$sst+273.15)/100))+(SuessR.reference.data.custom$S*(SuessR.reference.data.custom$B1+SuessR.reference.data.custom$B2*((SuessR.reference.data.custom$sst+273.15)/100)+SuessR.reference.data.custom$B3*((SuessR.reference.data.custom$sst+273.15)/100)^2))
  laws <- data.frame(lnK0 = lnK0)
